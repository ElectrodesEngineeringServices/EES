...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* Company Intro */}
     <section className="bg-gray-100 pt-16 pb-0">
...
From concept to completion, we provide complete Engineering, Procurement,
Installation, and Maintenance solutions. Our commitment to quality,
innovation, and client satisfaction has made us a reliable partner for
industrial and commercial projects across Pakistan.
</p>
      ...
      {/* Services */}
      <section className="bg-gray-100 pt-20 pb-0">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-10 text-center">
            ...
            <div>
              ...
              <p className="mt-3">Completed Projects</p>
            </div>

            <div>
              <h2 className="text-primary text-5xl font-bold">100%</h2>
              <p className="mt-3">Client Satisfaction</p>
            </div>

            <div>
              <h2 className="text-primary text-5xl font-bold">24/7</h2>
